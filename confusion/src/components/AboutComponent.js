...
function RenderLeader({leader}) {
  return(
    <Media>
    <Media left>
    <Media object  width="80" height="80" className="mr-5" src={baseUrl + leader.image} alt={leader.name}/>
    </Media>
      <Media body>
...
function RenderData({ isLoading, errMess, leaders }) {
  if(isLoading) {
    return (
      <Loading />
    )
    ...
    return (
          <div className="container">
              ...
              <div className="row row-content">
                  ...
                  <div className="col-12">
                    <Stagger in>
                      <RenderData isLoading={props.isLoading} errMess={props.errMess} leaders={props.leaders.leaders} />
                    </Stagger>
                  </div>
              </div>
          </div>
